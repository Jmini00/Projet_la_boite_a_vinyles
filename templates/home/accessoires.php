...
<head>
    ...
    <meta name="description" content="Accessoires - La Boite à Vinyles">
    <title>Accessoires - La Boite à Vinyles</title>
...
<div id="side-nav">
    ...
    <!--<i class="fa-solid fa-bars fa-2x" id="mobile-bt"></i>-->
    ...
    <main>
        <h3>Cette section arrive prochainement</h3>
    </main>
